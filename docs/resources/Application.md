...
| summary                | string                                                     | **Deprecated** previously if this application is a game sold on Discord, this field will be the summary field for the store page of its primary sku, now an empty s  |
